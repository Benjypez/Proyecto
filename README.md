...
- El programa está orientado a una ejecución académica en consola.
- Las contraseñas se almacenan como texto sin cifrar.
- Los archivos `.dat` dependen de la estructura binaria utilizada por el programa.
- La clasificación semanal considera cuatro semanas por mes; los días posteriores al 28 se asignan a la semana 4.
- El sistema utiliza funciones específicas de Windows para limpiar y pausar la consola.
...
- Permitir eliminar y editar productos.
- Implementar detalle completo de productos por venta.
- Validar fechas considerando la cantidad real de días de cada mes.
- Evitar números de factura duplicados.
- Añadir respaldo y recuperación de datos.
- Migrar la persistencia a una base de datos.
- Hacer el programa compatible con Linux y macOS.

---

## 👨‍💻 Equipo

Proyecto desarrollado como trabajo académico de Programación en C.

| Integrante | Responsabilidad |
|---|---|
| Integrante 1 | Estructuras, prototipos y explicación general |
| Integrante 2 | Menús, validaciones, usuarios e inventario |
| Integrante 3 | Ventas, reportes, archivos y memoria dinámica |
